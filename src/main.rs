...
const HACKERS_MOVIE_VARIANT: &str = r#"This is our world now... the world of the electron and the switch, the beauty of the baud.
...
#[pyfunction]
fn get_hackers_manifesto() -> &'static str {
    HACKERS_MANIFESTO
}
